    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="选题备注" prop="xuantibeizhu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="选题备注"
                  v-model="ruleForm.xuantibeizhu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuantibeizhu" label="选题备注" prop="xuantibeizhu">
                    <span>{{ruleForm.xuantibeizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
