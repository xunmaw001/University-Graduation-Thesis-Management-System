<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="答辩名称" prop="dabianmingcheng">
          <el-input v-model="ruleForm.dabianmingcheng" 
              placeholder="答辩名称" clearable  :readonly="ro.dabianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="答辩名称" prop="dabianmingcheng">
              <el-input v-model="ruleForm.dabianmingcheng" 
                placeholder="答辩名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="答辩成绩" prop="dabianchengji">
          <el-input v-model="ruleForm.dabianchengji" 
              placeholder="答辩成绩" clearable  :readonly="ro.dabianchengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="答辩成绩" prop="dabianchengji">
              <el-input v-model="ruleForm.dabianchengji" 
                placeholder="答辩成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="答辩结果" prop="dabianjieguo">
        ...
        <div v-else>
          <el-form-item class="input" label="答辩结果" prop="dabianjieguo">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="答辩时间" prop="dabianshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dabianshijian" label="答辩时间" prop="dabianshijian">
              <el-input v-model="ruleForm.dabianshijian" 
                placeholder="答辩时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	userid : false,
      ...
      rules: {
          ...
          dabianmingcheng: [
                { required: true, message: '答辩名称不能为空', trigger: 'blur' },
          ],
          xiangguantupian: [
          ],
          dabianchengji: [
          ...
          dabianjieguo: [
                { required: true, message: '答辩结果不能为空', trigger: 'blur' },
          ],
          dabianshijian: [
          ],
          xuehao: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.suozaiyuanxi = true;
          ...
          if(o=='dabianmingcheng'){
            this.ruleForm.dabianmingcheng = obj[o];
	    this.ro.dabianmingcheng = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.dabianjieguoOptions = "不通过,通过".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `dabianmingdan/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dabianmingdan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dabianmingdanCrossAddOrUpdateFlag = false;
						 this.parent.search();
