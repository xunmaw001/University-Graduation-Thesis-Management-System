<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="难度" prop="nandu">
          <el-input v-model="ruleForm.nandu" 
              placeholder="难度" clearable  :readonly="ro.nandu"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.lunwentupian" label="论文图片" prop="lunwentupian">
          <file-upload
          tip="点击上传论文图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.lunwentupian?ruleForm.lunwentupian:''"
          @change="lunwentupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.lunwentupian" label="论文图片" prop="lunwentupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.lunwentupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="论文内容" prop="lunwenneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="论文内容"
                  v-model="ruleForm.lunwenneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.lunwenneirong" label="论文内容" prop="lunwenneirong">
                    <span>{{ruleForm.lunwenneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	if(this.ruleForm.lunwentupian!=null) {
		this.ruleForm.lunwentupian = this.ruleForm.lunwentupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    lunwentupianUploadChange(fileUrls) {
	this.ruleForm.lunwentupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
