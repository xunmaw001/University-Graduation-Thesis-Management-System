  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="所在院系" prop="suozaiyuanxi">
          <el-input v-model="ruleForm.suozaiyuanxi"               placeholder="所在院系" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="所在院系" prop="suozaiyuanxi">
          <el-input v-model="ruleForm.suozaiyuanxi"               placeholder="所在院系" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
